  ...
  revealjs:
    ...
    include-in-header:
      text: |
        ...
        /* Setup checklist: bullets replaced by empty check boxes. */
        .reveal .setup-check ul { list-style: none; margin-left: 0; }
        .reveal .setup-check li::before {
          content: "\2610";
...
::: incremental
-   Automatic spacing, indentation, and style
-   Improves readability
-   Set up to run **on save** in this course's project
:::

## AI tools and coding {.smaller}

The new AI tools for coding may make it easier to generate code, but they make it **much harder** to verify. 

This makes these skills even more important.
...
# Next: Confirm your setup and starting the demo
...
-   Data downloaded from itslearning
-   Demo file 1 open
:::
:::